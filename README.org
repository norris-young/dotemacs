...
5. fonts
   ...
   3) [[https://glyphwiki.org/hanazono/][HanaMinB]] (linux only, PMingLiu-ExtB is used on windows)
...
6. lsp servers
   ...
   3) [[https://github.com/regen100/cmake-language-server][cmake-language-server]]
   4) [[https://github.com/bash-lsp/bash-language-server][bash-language-server]]
